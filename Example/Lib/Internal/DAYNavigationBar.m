...
- (void)commonInit {
    ...
    [self.prevButton setImage:[UIImage imageNamed:@"icon_the_left1"] forState:UIControlStateNormal];
    ...
    [self.nextButton setImage:[UIImage imageNamed:@"icon_the_right1"] forState:UIControlStateNormal];
